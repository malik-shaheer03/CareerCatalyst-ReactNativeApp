...
const difficultyLevels = [
  { value: "beginner", label: "Beginner", description: "Entry-level questions and basic concepts" },
  { value: "intermediate", label: "Intermediate", description: "Mid-level experience with practical scenarios" },
  { value: "advanced", label: "Advanced", description: "Senior-level questions and complex problem-solving" },
];
...
export default function InterviewSetupScreen() {
  ...
  const steps = ["Select Job Title", "Choose Difficulty", "AI Interview"];

  const handleStartInterview = () => {
    if (selectedJob && selectedDifficulty) {
      router.push({
        pathname: '/(tabs)/interview-bot',
        params: {
          ...
          <View style={styles.stepContent}>
            <View style={styles.stepHeader}>
              ...
              <Text style={styles.stepSubtitle}>
                Choose the job role you want to practice interviewing for
              </Text>
            </View>
        ...
        return (
          <View style={styles.stepContent}>
            <View style={styles.stepHeader}>
              ...
              <Text style={styles.stepTitle}>Choose Interview Difficulty</Text>
              <Text style={styles.stepSubtitle}>
            ...
            {/* Centered Start Interview Button */}
            <TouchableOpacity
